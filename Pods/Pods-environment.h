...
// VWebService
#define COCOAPODS_POD_AVAILABLE_VWebService
#define COCOAPODS_VERSION_MAJOR_VWebService 1
#define COCOAPODS_VERSION_MINOR_VWebService 0
#define COCOAPODS_VERSION_PATCH_VWebService 2
